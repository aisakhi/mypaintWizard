...
OptionSet6 = tk.Checkbutton(frameP3, font = fontNormal,anchor = tk.W,variable=page2Vars[6], text =" Set #5 (ADD COLOR to palette)")

checkBrushSliders = tk.Label(frameP3, text = " The 'Add color'  option helps to add the extra shade from a color wheel or cube to the palette:")
...
OptionSet6.grid(row = 6, column = 1, columnspan = 2, sticky = tk.W)
checkBrushSliders.grid(row = 10, column = 1, columnspan = 2, sticky = tk.W)
